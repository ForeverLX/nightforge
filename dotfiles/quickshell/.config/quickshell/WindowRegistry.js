...
function getLayout(name, mx, my, mw, mh, userScale) {
    ...
    let base = {
        "battery":     { w: s(450, scale), h: s(480, scale), rx: mw - s(454, scale), ry: s(60, scale), comp: "battery/BatteryPopup.qml" },
        "network":     { w: s(900, scale), h: s(700, scale), rx: mw - s(904, scale), ry: s(60, scale), comp: "network/NetworkPopup.qml" },
        "audio":       { w: s(320, scale), h: s(320, scale), rx: mw - s(324, scale), ry: s(60, scale), comp: "audio/AudioDevicePopup.qml" },
        "connections": { w: s(420, scale), h: mh, rx: s(0, scale), ry: s(0, scale), comp: "connections/ConnectionsPopup.qml" },
        ...
        "dashboard":   { w: s(1200, scale), h: s(850, scale), rx: Math.floor((mw/2)-(s(1200, scale)/2)), ry: Math.floor((mh/2)-(s(850, scale)/2)), comp: "modules/widgets/DashboardWidget.qml" },
        ...
        "movies":      { w: s(1370, scale), h: s(850, scale), rx: Math.floor((mw/2)-(s(1370, scale)/2)), ry: mh - s(850, scale), comp: "movies/MovieWidget.qml" },
