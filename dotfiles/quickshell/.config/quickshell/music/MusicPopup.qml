...
Item {
    ...
    Process {
        id: musicProc
        running: true
        command: ["bash", "-c", "$HOME/.config/quickshell/scripts/music_info.sh"]
                        ...
                        Rectangle {
                            ...
                            Item {
                                ...
                                Image {
                                    id: artImg
                                    anchors.fill: parent
                                    source: root.musicData.artUrl ? (String(root.musicData.artUrl).startsWith("file://") ? root.musicData.artUrl : "file://" + root.musicData.artUrl) : ""
                                    fillMode: Image.PreserveAspectCrop
                                    visible: false 
                                }
                                Rectangle {
