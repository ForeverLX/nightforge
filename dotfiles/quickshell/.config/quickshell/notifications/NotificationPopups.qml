        ...
        ListView {
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    property color blob1Color: contentWrapper.blobPalette1 && contentWrapper.blobPalette1.length > 0 && index !== undefined ? contentWrapper.blobPalette1[index % contentWrapper.blobPalette1.length] : _theme.mauve
                    property color blob2Color: contentWrapper.blobPalette2 && contentWrapper.blobPalette2.length > 0 && index !== undefined ? contentWrapper.blobPalette2[index % contentWrapper.blobPalette2.length] : _theme.sapphire
