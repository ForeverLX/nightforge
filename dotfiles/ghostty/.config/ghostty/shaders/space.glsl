#define LAYERS        3
#define DENSITY       50.0
#define STAR_SIZE     0.10
#define BRIGHTNESS    1.2
#define STAR_COLOR    vec3(0.9, 0.93, 1.0)
#define BLEND_THRESH  0.5
#define MIN_VISIBILITY 0.4    // 40% minimum star visibility
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    float blend = max(smoothstep(BLEND_THRESH * 0.4, BLEND_THRESH, 1.0 - luma), MIN_VISIBILITY);
